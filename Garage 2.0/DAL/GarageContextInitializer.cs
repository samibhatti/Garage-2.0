    ...
    internal class GarageContextInitializer : DropCreateDatabaseAlways<Garage_2_5_Context>
    {
        protected override void Seed(Garage_2_5_Context context)
        {
            ...
            var vehicles = new Vehicle[]
            {
                ...
                new Vehicle { RegNr = "MPJ 748", Color = "White", ParkingLotNumber = "A5", MemberId = members[3].MemberId, ParkingStartTime = DateTime.Now,  NumberOfTyres = 4, Model = "V4", Brand = "BMW",  VehicleTypeId = vehicleTypes[1].Id },
                new Vehicle { RegNr = "ZWK 844", Color = "Silver", ParkingLotNumber = "A6",MemberId = members[1].MemberId, ParkingStartTime = DateTime.Now, NumberOfTyres = 4, Model = "V9",  Brand = "Scania", VehicleTypeId = vehicleTypes[2].Id},
                new Vehicle { RegNr = "PTA 434", Color = "Black", ParkingLotNumber = "A7", MemberId = members[4].MemberId, ParkingStartTime = DateTime.Now, NumberOfTyres = 4, Model = "V6",  Brand = "Volvo", VehicleTypeId = vehicleTypes[2].Id },
                new Vehicle { RegNr = "QGK 443", Color = "Blue", ParkingLotNumber = "A8",  MemberId = members[2].MemberId, ParkingStartTime = DateTime.Now, NumberOfTyres = 2, Model = "V4",  Brand = "Honda", VehicleTypeId = vehicleTypes[0].Id },
                new Vehicle { RegNr = "RPG 455", Color = "Pink", ParkingLotNumber = "A9",  MemberId = members[1].MemberId, ParkingStartTime = DateTime.Now,  NumberOfTyres = 4, Model = "V3", Brand = "Mazda", VehicleTypeId = vehicleTypes[2].Id },
                new Vehicle { RegNr = "TFK 467", Color = "Red", ParkingLotNumber = "A10",  MemberId = members[0].MemberId, ParkingStartTime = DateTime.Now,  NumberOfTyres = 4, Model = "V7", Brand = "Nissan", VehicleTypeId = vehicleTypes[1].Id }
            };
